        ...
        return(
            <View style = {{flex : 0.06, alignItems : 'flex-start', justifyContent : 'center'}}>
                <View style = {{flex : 1, flexDirection : 'row'}}>
                    <Text style = {{flex : 5,paddingHorizontal : 15, fontWeight :'bold', fontSize : 25}}>{this.props.HeaderTitle} 새소식</Text>
...
export default class News extends React.Component{
    ...
    render(){
        ...
        var HeaderTitle;
        if(this.props.route.params) HeaderTitle = this.props.route.params.city;
        else HeaderTitle = '관악구'
        return(
            <View style = {{flex : 1}}>
